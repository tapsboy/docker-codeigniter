...
#ADD database.php /app/CodeIgniter_2.2.0/application/database/configuration.php
#RUN chmod 644 /app/CodeIgniter_2.2.0/application/database/configuration.php
